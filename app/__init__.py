...
def create_app(environment="production"):
    ...
    app.add_url_rule('/api/vacunaciones_por_provincia/<string:nombre_provincia>', 'mostrar_vacunaciones_por_provincia',vacunados_por_provincia.mostrar_vacunacion_por_provincia, methods=['GET'])
    app.add_url_rule('/api/registrar_vacunacion/', 'registrar_vacunacion',vacunados.registrar_vacunacion, methods=['POST'])
